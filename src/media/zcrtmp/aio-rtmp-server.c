...
static void aio_rtmp_server_onaccept(void *param, int code, socket_t socket, const struct sockaddr *sa,
                                     socklen_t salen);
...
static int rtmp_handler_onplay(void *param, const char *app, const char *stream, double start, double duration,
                               uint8_t reset);
...
struct aio_rtmp_server_t *aio_rtmp_server_create(const char *ip, int port, struct aio_rtmp_server_handler_t *handler,
                                                 void *param) {
    socket_t socket;
...
int aio_rtmp_server_send_script(struct aio_rtmp_session_t *session, const void *data, size_t bytes,
                                uint32_t timestamp) {
