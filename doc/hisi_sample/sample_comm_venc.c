...
#define ZC_RTSP_TEST_FRAME_MAXSIZE (1*1024*1024)
#define ZC_RTSP_TEST_MAIN_SIZE (8*1024*1024)
#define ZC_RTSP_TEST_SUB_SIZE (8*1024*1024)
#define ZC_RTSP_TEST_SHM_PATH "video"
#define ZC_RTSP_VIDEO_MAGIC (0x5A435645)  // "ZCVE" ZC_STREAM_VIDEO_MAGIC
