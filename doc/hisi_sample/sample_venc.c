...
static hi_s32 sample_venc_vpss_init(hi_vpss_grp vpss_grp, sample_venc_vpss_chn_attr *vpss_chan_cfg)
{
    hi_s32 ret;
...
static hi_void sample_venc_vpss_deinit(hi_vpss_grp vpss_grp, sample_venc_vpss_chn_attr *vpss_chan_cfg)
{
    hi_s32 ret;
    ...
    hi_venc_gop_attr gop_attr, hi_bool qp_map)
{
    ...
    /* encode h.265 */
    #if ZC_RTSP_TEST
    chn_param[0].frame_rate = 60; /* 30: is a number */
    ...
    /* encode h.264 */
    #if ZC_RTSP_TEST
    chn_param[1].frame_rate = 60; /* 30: is a number */
